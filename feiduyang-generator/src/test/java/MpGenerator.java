...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 自定义 service 父类
        strategy.setSuperServiceClass("ICrudService");
        // 自定义 service 实现类父类
        strategy.setSuperServiceImplClass("com.feiduyang.core.support.impl.CrudServiceImpl");
        // 自定义 controller 父类
        strategy.setSuperControllerClass("BaseCrudController");
